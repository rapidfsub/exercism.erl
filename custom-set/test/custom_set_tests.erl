...
'17_set_is_not_a_subset_of_set_that_does_not_contain_its_elements_test_'() ->
  {"set is not a subset of set that does not contain its elements",
   ?_assertNot(custom_set:subset(
                 custom_set:from_list([1, 2, 3]), custom_set:from_list([4, 1, 3])))}.

'18_the_empty_set_is_disjoint_with_itself_test_'() ->
  {"the empty set is disjoint with itself",
   ?_assert(custom_set:disjoint(
              custom_set:from_list([]), custom_set:from_list([])))}.
...
'21_sets_are_not_disjoint_if_they_share_an_element_test_'() ->
  {"sets are not disjoint if they share an element",
   ?_assertNot(custom_set:disjoint(
                 custom_set:from_list([1, 2]), custom_set:from_list([2, 3])))}.

'22_sets_are_disjoint_if_they_share_no_elements_test_'() ->
  {"sets are disjoint if they share no elements",
   ?_assert(custom_set:disjoint(
              custom_set:from_list([1, 2]), custom_set:from_list([3, 4])))}.

'23_add_to_empty_set_test_'() ->
  {"add to empty set",
   ?_assert(custom_set:equal(
              custom_set:from_list([3]), custom_set:add(3, custom_set:from_list([]))))}.
...
'27_intersection_of_an_empty_set_and_non_empty_set_is_an_empty_set_test_'() ->
  {"intersection of an empty set and non-empty set is an empty "
   "set",
   ?_assert(custom_set:equal(
              custom_set:from_list([]),
              custom_set:intersection(
                custom_set:from_list([]), custom_set:from_list([3, 2, 5]))))}.

'28_intersection_of_a_non_empty_set_and_an_empty_set_is_an_empty_set_test_'() ->
  {"intersection of a non-empty set and an empty set is an empty "
   "set",
   ?_assert(custom_set:equal(
              custom_set:from_list([]),
              custom_set:intersection(
                custom_set:from_list([1, 2, 3, 4]), custom_set:from_list([]))))}.

'29_intersection_of_two_sets_with_no_shared_elements_is_an_empty_set_test_'() ->
  {"intersection of two sets with no shared elements is an empty "
   "set",
   ?_assert(custom_set:equal(
              custom_set:from_list([]),
              custom_set:intersection(
                custom_set:from_list([1, 2, 3]), custom_set:from_list([4, 5, 6]))))}.

'30_intersection_of_two_sets_with_shared_elements_is_a_set_of_the_shared_elements_test_'() ->
  {"intersection of two sets with shared elements is a set of the "
   "shared elements",
   ?_assert(custom_set:equal(
              custom_set:from_list([2, 3]),
              custom_set:intersection(
                custom_set:from_list([1, 2, 3, 4]), custom_set:from_list([3, 2, 5]))))}.
...
'33_difference_of_a_non_empty_set_and_an_empty_set_is_the_non_empty_set_test_'() ->
  {"difference of a non-empty set and an empty set is the non-empty "
   "set",
   ?_assert(custom_set:equal(
              custom_set:from_list([1, 2, 3, 4]),
              custom_set:difference(
...
'34_difference_of_two_non_empty_sets_is_a_set_of_elements_that_are_only_in_the_first_set_test_'() ->
  {"difference of two non-empty sets is a set of elements that "
   "are only in the first set",
   ?_assert(custom_set:equal(
              custom_set:from_list([1, 3]),
              custom_set:difference(
                custom_set:from_list([3, 2, 1]), custom_set:from_list([2, 4]))))}.
...
'36_union_of_an_empty_set_and_non_empty_set_is_the_non_empty_set_test_'() ->
  {"union of an empty set and non-empty set is the non-empty set",
   ?_assert(custom_set:equal(
              ...
              custom_set:union(
                custom_set:from_list([]), custom_set:from_list([2]))))}.
...
'37_union_of_a_non_empty_set_and_empty_set_is_the_non_empty_set_test_'() ->
  {"union of a non-empty set and empty set is the non-empty set",
   ?_assert(custom_set:equal(
              custom_set:from_list([1, 3]),
              custom_set:union(
                custom_set:from_list([1, 3]), custom_set:from_list([]))))}.

'38_union_of_non_empty_sets_contains_all_unique_elements_test_'() ->
  {"union of non-empty sets contains all unique elements",
   ?_assert(custom_set:equal(
              custom_set:from_list([3, 2, 1]),
              custom_set:union(
                custom_set:from_list([1, 3]), custom_set:from_list([2, 3]))))}.
